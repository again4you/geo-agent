...
import { _rules, runStrategy } from "./strategy-agent.js";
...
describe("Strategy Agent", () => {
    ...
    describe("runStrategy — LLM enhancement", () => {
        it("uses LLM when use_llm=true and chatLLM provided", async () => {
            ...
            const result = await runStrategy({ target_id: "t1", analysis_report: makeReport(), use_llm: true }, { chatLLM: mockChat });
...
//# sourceMappingURL=strategy-agent.test.js.map