...
import { z } from "zod";
import { buildPageContext, escapeHtml, extractTitle, extractVisibleText, parseJsonResponse, safeLLMCall, truncateHtml, } from "./llm-helpers.js";
...
describe("safeLLMCall", () => {
    ...
    it("returns parsed result when chatLLM succeeds", async () => {
        ...
        const result = await safeLLMCall(chatLLM, { prompt: "test" }, (c) => c.toUpperCase(), "fallback");
    ...
    it("returns fallback when parser throws", async () => {
        ...
        const result = await safeLLMCall(chatLLM, { prompt: "test" }, () => {
...
describe("escapeHtml", () => {
    ...
    it("escapes quotes", () => {
        expect(escapeHtml("He said \"hello\" & 'bye'")).toBe("He said &quot;hello&quot; &amp; &#39;bye&#39;");
    });
    it("returns empty string unchanged", () => {
        expect(escapeHtml("")).toBe("");
    });
});
//# sourceMappingURL=llm-helpers.test.js.map