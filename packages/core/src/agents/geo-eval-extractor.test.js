...
import { analyzePathAccess, extractGeoEvaluationData, extractMarketingClaims, extractProductInfo, extractSchemaCoverage, generateFindings, generateImprovements, parseRobotsTxt, } from "./geo-eval-extractor.js";
...
describe("generateFindings", () => {
    ...
    it("generates strengths for allowed bots", () => {
        const result = generateFindings(botPolicies, { exists: false, content_preview: null }, [
            {
    ...
    it("generates opportunities for missing schemas", () => {
        ...
        const result = generateFindings(botPolicies, { exists: false, content_preview: null }, schemas, [], {
            script_count: 5,
            external_scripts: 3,
            inline_scripts: 2,
            frameworks_detected: [],
...
//# sourceMappingURL=geo-eval-extractor.test.js.map