...
import { ChangeEntrySchema, OptimizationReportSchema, ReportBuilder, ScoreComparisonSchema, renderSimpleDiff, } from "./report-generator.js";
// ─── ChangeEntrySchema ──────────────────────────────────────────
...
describe("ScoreComparisonSchema", () => {
    ...
    it("rejects missing required fields", () => {
        expect(() => ScoreComparisonSchema.parse({
            dimension: "citation_rate",
            before: 40,
        })).toThrow();
    });
