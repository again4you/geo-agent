...
import { classifySubtype, findReference, getTabSpec, listReferences, loadVisualizationSpec, validateQualityBar, } from "./viz-spec-loader.js";
import { SUBTYPE_BY_SITE_TYPE, SUBTYPE_SIGNALS, SiteSubtypeSchema, TabSpecSchema, VizElementTypeSchema, VisualizationSpecSchema, } from "./viz-spec-schema.js";
// ── Schema Validation ──────────────────────────────────────
...
describe("Manufacturer Electronics Reference", () => {
    ...
    it("competitor estimation enabled with ≥3 max", () => {
        ...
        expect(MANUFACTURER_ELECTRONICS_REF.competitor_estimation?.max_competitors).toBeGreaterThanOrEqual(3);
    });
