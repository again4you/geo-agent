...
import type { SiteType } from "./evaluation-templates/index.js";
import { TemplateEngine, classifySite } from "./template-engine.js";
import type { ClassificationResult, TemplateParams } from "./template-engine.js";
...
describe("TemplateEngine", () => {
	...
	describe("loadTemplate", () => {
		...
		it("throws for invalid site type", () => {
			expect(() => engine.loadTemplate("invalid" as SiteType)).toThrow();
		});
	...
	describe("getTemplateInfo", () => {
		...
		it("throws for unknown site type", () => {
			expect(() => engine.getTemplateInfo("nonexistent" as SiteType)).toThrow();
		});

		it("scoring dimensions weights sum to 1.0", () => {
			for (const siteType of ["manufacturer", "research", "generic"] as SiteType[]) {
